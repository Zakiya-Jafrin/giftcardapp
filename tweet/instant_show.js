...
done(); //done should be called as soon as the document is reday
...
function updates(){
    ...
    //make "show" empty in order to avoid duplication
        ...
        $("#show").prepend(this['name']+" updated "+" card number "+"<b>"+this['card_number']+"</b>"+" at "+this['time']+"<hr></br>");
        // Stephen Dick updated card number WFWG00239 at 2016-08-10 10:34:15
        });
